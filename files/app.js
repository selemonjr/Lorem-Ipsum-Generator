...
//listening to a submit click on the generate button//
form.addEventListener("submit",(e)=> {
    e.preventDefault();
//parseInt is used to change an integer into a string then later to an integer
    const value = parseInt(amount.value);
//We are using Math.floor() to get a whole number//
    const random = Math.floor(Math.random() * text.length);
//isNaN means is Not a Number. So we are passing a conditional statement//
